...
Hack8ball_CFLAGS = -fobjc-arc
Hack8ball_CCFLAGS = -std=c++11 -fno-rtti -fno-exceptions -DNDEBUG
...
Hack8ball_FILES = Tweak.xm $(MENU_SRC) $(KITTYMEMORY_SRC) $(SCLALERTVIEW_SRC)

Hack8ball_LIBRARIES += substrate

Hack8ball_FRAMEWORKS = $(PROJ_COMMON_FRAMEWORKS)
# GO_EASY_ON_ME = 1
...
after-install::
	install.exec "killall -9 8ball.app || :"
